...
require_admin_role(['agent'], $admin_base);
        ...
        elseif (!in_array($channel, ['upi','bank','wallet','cash','gateway','other'], true)) $error = 'Invalid channel.';
            ...
            try {
                if ($action === 'create') {
                    ...
                    $stmt = $pdo->prepare("INSERT INTO player_deposit_methods (agent_id, label, channel, enabled, sort_order, details_json)
                        VALUES (?, ?, ?, ?, ?, ?)");
...
$mine = $pdo->prepare("SELECT * FROM player_deposit_methods WHERE agent_id=? ORDER BY sort_order ASC, id DESC");
$mine->execute([$my_id]);
$mine = $mine->fetchAll();
?>
  ...
  <div class="col-12 col-lg-6">
    <div class="card">
      <div class="card-header">
        ...
        <div class="text-body-secondary">Methods set by master</div>
      </div>
      <div class="card-body">
                ...
                <div class="border rounded p-3">
                  ...
                  <div class="mt-3 row g-2">
                    ...
                    <?php elseif ($channel === 'wallet'): ?>
                      ...
                      <?php endif; ?>
                      <?php if (!empty($d['wallet_number'])): ?>
                        <div class="col-12 col-md-6">
                          <div class="small text-body-secondary">Address</div>
                          <div class="fw-semibold"><?php echo htmlspecialchars((string)$d['wallet_number']); ?></div>
                        </div>
                      <?php endif; ?>
                    <?php else: ?>
        ...
        <?php else: ?>
          <div class="text-center text-body-secondary py-4">No deposit methods configured.</div>
        <?php endif; ?>
      </div>
    </div>
  </div>
  ...
  <div class="col-12 col-lg-6">
    <div class="card mb-4">
      <div class="card-header">
        ...
        <div class="text-body-secondary">Visible to players</div>
      </div>
      <div class="card-body">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="text-body-secondary">Your methods for players</div>
      </div>
      <div class="card-body">
        <?php if (!empty($mine)): ?>
