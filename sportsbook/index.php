...
$sb_build_stamp = 'b20260530vr4';  // fix: MERGE markets across bookmakers (corners=1xbet, cards=Bookings, HT=Bet365) instead of picking one; valid bookmaker set; French names for corners/cards spread+team
