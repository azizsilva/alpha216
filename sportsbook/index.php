...
$sb_build_stamp = 'b20260530vr5';  // fix: upcoming used dead /events/upcoming endpoint -> now /events filtered (2500+ events, 8 days); league page reads Redis; dedicated fast football upcoming loop; bookmaker set = account-selected
